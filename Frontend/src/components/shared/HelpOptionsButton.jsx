        ...
        <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3">
            ...
            {isOpen && (
                <div className="flex flex-col gap-2 mb-2 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    >
                        <span className="material-symbols-outlined text-sm group-hover:scale-110 transition-transform" style={{ color: '#137fec', fontSize: '18px' }}>auto_awesome</span>
                    ...
                    >
                        <span className="material-symbols-outlined text-sm group-hover:scale-110 transition-transform" style={{ color: '#3b9af5', fontSize: '18px' }}>smart_toy</span>
            ...
            <button
                ...
                className={`w-12 h-12 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 ${isOpen ? 'rotate-90' : 'hover:scale-110'} text-white`}
                style={{
                ...
                title="Help & Support"
            >
                <span className="material-symbols-outlined" style={{ fontSize: '24px' }}>{isOpen ? 'close' : 'help_outline'}</span>
            </button>
        </div>
    );
};
